...
awful.screen.connect_for_each_screen(function(s)
    ...
    local batWidget = battery_widget {
	ac = "AC",
	adapter = "BAT0",
	ac_prefix = "AC: ",
	battery_prefix = "Bat: ",
...
globalkeys = gears.table.join(
    ...
    -- Language Layout
    awful.key({ "Mod1" }, "space", function () kbdcfg.switch_next() end),
    awful.key({ }, "XF86AudioRaiseVolume",
              function ()
	          if wasMutted then
	              wasMutted = false
                      awful.util.spawn("amixer -D pulse sset Master 55%")
	          else 
    ...
    awful.key({ }, "XF86AudioLowerVolume",
	          ...
	          if wasMutted then
	              wasMutted = false
                      awful.util.spawn("amixer -D pulse sset Master 45%")
	          else 
                      awful.util.spawn("amixer -D pulse sset Master 5%-")
	          end
              end),
    awful.key({ }, "XF86AudioMute",
              function ()
                  if wasMutted then
                      wasMutted = false
                      awful.util.spawn("amixer -D pulse sset Master 50%")
                  else
                      wasMutted = true
